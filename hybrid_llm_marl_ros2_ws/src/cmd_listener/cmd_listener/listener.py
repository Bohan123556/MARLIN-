...
policy_path_root = "/home/toby/projects/uni/internship/Hybrid_LLM_MARL/models/"
policy_path = (lambda is_hybrid, ep,
                      trial: f"{policy_path_root}{'hybrid' if is_hybrid else 'marl'}/episode_{ep}/trial_{trial}")
csv_path_root = "/home/toby/projects/uni/internship/Hybrid_LLM_MARL/ros_results/"
REPEATS = 5
...
def main(args = None):
  ...
  for is_hybrid in [2]:  # 0 is hybrid, 1 is MARL, 2 is llm
    for episode in [100, 350, 600, 850, 1100, 1350, 1600]:
      ...
      Utils.set_csv_file("ros", "/home/toby/projects/uni/internship/Hybrid_LLM_MARL/ros_results",
